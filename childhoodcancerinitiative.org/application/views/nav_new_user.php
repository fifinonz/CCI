<div class="sidebar col-md-3 pull-right">
    <div class="sidebar-widget">
        ...
        <ul class="sidebar-list">
            ...
            <li><a style="font-size: 18px" href="<?php echo base_url();?>auth/create_user" title="">Create A Relay Team</a></li>
            <li><a style="font-size: 18px" href="<?php echo base_url();?>auth/login" title="">Join A Team</a></li>
        </ul>
    </div><!-- Category List -->
    <div class="sidebar-widget">
        <div class="sidebar-title">
        ...
        <div class="cloud-tags">
            ...
            <a style="font-size: 16px"href="<?php echo base_url();?>auth/login" title="">Sign Up</a>
    ...
    <div class="sidebar-widget">
        ...
        <div class="donate-us">
            <h3 style="font-size: 20px"><strong>Support KENCASA TODAY!</strong></h3>
